...
\begin{frame}{The Real Number System}
    \begin{itemize}
        ...
        \item We take the familiar algebraic and order properties of the real
        numbers as given; their formal statement is included in the appendix.
    \end{itemize}
\end{frame}
...
\begin{frame}[allowframebreaks]{Algebraic Axioms for the Real Numbers}
...
\begin{frame}[allowframebreaks]
    \frametitle{Order Axioms for the Real Numbers}
    \begin{itemize}
