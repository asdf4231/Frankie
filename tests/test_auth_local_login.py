...
def test_seeded_default_user_can_login_and_change_password(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(web.settings, "auth_admin_users", ["36020251155156"], raising=False)
    ...
    login = client.post(
        "/api/auth/login",
        json={"user_id": "36020251155156", "password": "12345678"},
    )
    ...
    change = client.post(
        ...
        json={"old_password": "12345678", "new_password": "NewPass!123"},
    )
