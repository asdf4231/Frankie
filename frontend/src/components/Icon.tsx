...
/* Inline stroke icons (Lucide, MIT). 24px grid, 1.75 stroke, currentColor.
   Add icons here rather than inlining SVG in views. */
const ICONS = {
  'square-pen': <>
  ...
  'wrench': <>
    <path d="M14.7 6.3a6 6 0 0 1 3 3l-1.2 1.2a2 2 0 0 1-2.8 0L12.3 9.1a2 2 0 0 1 0-2.8L13.5 5.1a6 6 0 0 1 3 0Z" />
    <path d="M6.5 14.5 4 17l2 2 2.5-2.5" />
    <path d="M14 14l-2.5 2.5" />
    <path d="M6.5 14.5a4 4 0 0 1 0-5.7l1.2-1.2a4 4 0 0 1 5.7 0l-1.2 1.2a2 2 0 0 0-2.8 2.8L6.5 14.5Z" />
  </>,
  'sun': <>
